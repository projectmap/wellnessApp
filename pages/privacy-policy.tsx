...
const PrivacyPolicy: NextPage = () => {
  const matchesLG = useMediaQuery('(max-width:1096px)');

  return (
    <Box sx={{ background: '#E4E8F1', minHeight: '100vh' }}>
      ...
      <Container maxWidth="xl" sx={{ mt: 1, pt: 7 }}>
        <Typography variant="h3" sx={{ pb: 3, color: '#5A5A72' }}>
          Privacy policy
        </Typography>
        ...
        <Typography variant="body1" sx={{ pb: 3 }}>
          ...
          <ul>
            ...
            <li>
              <b>Application</b> refers to NEWSTART Online, the software program provided by the Company.
            </li>
            <li>
              <b>Company</b> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or
              &quot;Our&quot; in this Agreement) refers to NEWSTART, 2601 West Paoli Lane, Weimar, CA 95736.
            </li>
            <li>
            ...
            <li>
              <b>Website</b> refers to NEWSTART Online, accessible from https://www.newstart.com/online/
            </li>
            <li>
        ...
        <Typography variant="body1" sx={{ pb: 3 }}>
          ...
          to: Email address First name and last name Phone number Address, State, Province, ZIP/Postal code, City Usage
          Data
        </Typography>
        <Typography variant="h4" sx={{ pb: 3, color: '#5A5A72' }}>
          Usage Data
        ...
        <Typography variant="body1" sx={{ pb: 3 }}>
          ...
          Your mobile device unique ID, the IP address of Your mobile device, Your mobile operating system, the type of
          mobile Internet browser You use, unique device identifiers and other diagnostic data. We may also collect
        ...
        <Typography variant="body1" sx={{ pb: 3 }}>
          ...
          <ul>
            ...
            <li>
              <b>Web Beacons.</b> Certain sections of our Service and our emails may contain small electronic files
        ...
        <Typography variant="body1" sx={{ pb: 3 }}>
          ...
          <ul>
            ...
            <li>
              ...
              as a mobile application&apos;s push notifications regarding updates or informative communications related
              to the functionalities, products or contracted services, including the security updates, when necessary or
              reasonable for their implementation.
            </li>
            <li>
              <b>To provide</b>
              You with news, special offers and general information about other goods, services and events which we
              offer that are similar to those that you have already purchased or enquired about unless You have opted
        ...
        <Typography variant="body1" sx={{ pb: 3 }}>
          ...
          governmental jurisdiction where the data protection laws may differ than those from Your jurisdiction. Your
          consent to this Privacy Policy followed by Your submission of such information represents Your agreement to
          that transfer. The Company will take all steps reasonably necessary to ensure that Your data is treated
        ...
        <Typography variant="body1" sx={{ pb: 3 }}>
          ...
          Service. You may update, amend, or delete Your information at any time by signing in to Your Account, if you
          have one, and visiting the account settings section that allows you to manage Your personal information. You
          may also contact Us to request access to, correct, or delete any personal information that You have provided
          to Us. Please note, however, that We may need to retain certain information when we have a legal obligation or
        ...
        <Typography variant="body1" sx={{ pb: 3 }}>
          ...
          and Your country requires consent from a parent, We may require Your parent&apos;s consent before We collect
